...
export const metadata = {
  title: "Sign In - ViralAI Publisher",
  description: "Sign in to your ViralAI Publisher account to discover and publish viral content.",
};
      ...
      <div className="w-full max-w-md z-10 animate-fade-in-up">
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center p-8 bg-[#13131A] rounded-xl border border-[#1E1E2D]">
            <LoadingSpinner />
            <p className="text-sm text-slate-400 mt-4">Loading login form...</p>
          </div>
        }>
          <LoginForm />
        </Suspense>
