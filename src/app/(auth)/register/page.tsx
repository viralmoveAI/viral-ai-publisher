...
export const metadata = {
  title: "Create an Account - ViralAI Publisher",
  description: "Register for a free ViralAI Publisher account to discover trending topics and automate your social sharing.",
};
      ...
      <div className="w-full max-w-md z-10 animate-fade-in-up">
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center p-8 bg-[#13131A] rounded-xl border border-[#1E1E2D]">
            <LoadingSpinner />
            <p className="text-sm text-slate-400 mt-4">Loading registration form...</p>
          </div>
        }>
          <RegisterForm />
        </Suspense>
